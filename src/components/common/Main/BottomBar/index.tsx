        ...
        <Box className={classes.main_container} px="xl" py={3}>
            {mainServicesList.map((value, idx) =>
                <Fragment>
                    {idx === 2 &&
                        <Box
                            className={navigationStore.active=== 0 ? `${classes.nav_link_dashboard} ${classes.nav_link_dashboard_active}` : classes.nav_link_dashboard}
                            ...
                            <ActionIcon className={classes.nav_link} variant="transparent" color="#5B6CF0">
                                <Image
                                    className={navigationStore.active === 0 ? classes.nav_link_icon_active : classes.nav_link_dashboard_icon}
                    ...
                    <ActionIcon className={classes.nav_link} variant="transparent" color="#5B6CF0"
                        ...
                        <Image className={navigationStore.active === idx + 1 ? classes.nav_link_icon_active : classes.nav_link_icon}
                               src={value.icon} h={30} w="auto" fit="contain"/>
                        {navigationStore.active === idx + 1 &&
